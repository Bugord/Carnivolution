...
namespace Enemy.MeleeEnemy.States
{
    public class ChaseState : IState
    {
        ...
        public ChaseState(MeleeEnemy enemy, PlayerController player, MovementController movementController, RotationController rotationController)
        {
            _enemy = enemy;
        ...
        public void OnEnter()
        {
            Debug.Log($"Chase: {_playerController.transform}");
        }
